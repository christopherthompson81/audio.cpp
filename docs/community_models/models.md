...
| **moss_ttsd** | TTS, voice cloning | en, zh | Chris [@christopherthompson81](https://github.com/christopherthompson81) | [MOSS-TTSD](moss_ttsd.md) 8B delay-pattern dialogue TTS: speaker-tagged conversation in one take, cloning each speaker by continuation |
| **moss_tts_v15** | TTS, voice cloning | en, zh | Chris [@christopherthompson81](https://github.com/christopherthompson81) | [MOSS-TTS-v1.5](moss_tts_v15.md) 8B delay-pattern zero-shot cloning from a short reference; voice-attribute instructions are followed only loosely |
